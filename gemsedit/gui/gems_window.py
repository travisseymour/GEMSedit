...
class Ui_ViewsWindow(object):
    def setupUi(self, ViewsWindow):
        ...
        self.actionOverview = QAction(ViewsWindow)
        self.actionOverview.setObjectName("actionOverview")
        self.actionOverview.setFont(font1)
        self.actionActionReference = QAction(ViewsWindow)
        self.actionActionReference.setObjectName("actionActionReference")
        self.actionActionReference.setFont(font1)
        ...
        self.actionClean_Media_Folder = QAction(ViewsWindow)
        self.actionClean_Media_Folder.setObjectName("actionClean_Media_Folder")
        self.actionClean_Media_Folder.setFont(font1)
        self.actionClear_Media_Cache = QAction(ViewsWindow)
        self.actionClear_Media_Cache.setObjectName("actionClear_Media_Cache")
        self.actionClear_Media_Cache.setFont(font1)
        ...
        self.menuHelp.addAction(self.actionActionReference)
        ...
        self.menuOther.addAction(self.actionClean_Media_Folder)
        self.menuOther.addAction(self.actionClear_Media_Cache)
    ...
    def retranslateUi(self, ViewsWindow):
        ...
        self.actionOverview.setText(QCoreApplication.translate("ViewsWindow", "Overview", None))
        self.actionActionReference.setText(QCoreApplication.translate("ViewsWindow", "Action Reference", None))
        ...
        # endif // QT_CONFIG(tooltip)
        self.actionClean_Media_Folder.setText(QCoreApplication.translate("ViewsWindow", "Simplify Media Folder", None))
        # if QT_CONFIG(tooltip)
        self.actionClean_Media_Folder.setToolTip(
            QCoreApplication.translate("ViewsWindow", "Move unused media files to _unused folder", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.actionClear_Media_Cache.setText(QCoreApplication.translate("ViewsWindow", "Clear Media Cache", None))
        # if QT_CONFIG(tooltip)
        self.actionClear_Media_Cache.setToolTip(
            QCoreApplication.translate("ViewsWindow", "Empty the GEMS media cache folder", None)
        )
        # endif // QT_CONFIG(tooltip)
