...
class Ui_GlobalActionsDialog(object):
    def setupUi(self, GlobalActionsDialog):
        if not GlobalActionsDialog.objectName():
            GlobalActionsDialog.setObjectName(u"GlobalActionsDialog")
        ...
        self.label_8.setPixmap(QPixmap(u":/newPrefix/media/Antialiasfactory-Jewelry-Agate.ico"))
        ...
        self.GAL_tableView.setObjectName(u"GAL_tableView")
        font5 = QFont()
        ...
        self.gaAdd_toolButton.setObjectName(u"gaAdd_toolButton")
        icon = QIcon()
        ...
        self.gaDel_toolButton.setObjectName(u"gaDel_toolButton")
        icon1 = QIcon()
        ...
        self.PAL_tableView.setObjectName(u"PAL_tableView")
        ...
        self.paAdd_toolButton.setObjectName(u"paAdd_toolButton")
        ...
        self.paDel_toolButton.setObjectName(u"paDel_toolButton")
    ...
    def retranslateUi(self, GlobalActionsDialog):
        GlobalActionsDialog.setWindowTitle(QCoreApplication.translate("GlobalActionsDialog", u"Task Action Editor", None))
        self.labelAppName.setText(QCoreApplication.translate("GlobalActionsDialog", u"GEMS Editor", None))
        self.label_8.setText("")
        self.label.setText(QCoreApplication.translate("GlobalActionsDialog", u"Global Environment Actions", None))
        self.closeButton.setText(QCoreApplication.translate("GlobalActionsDialog", u"Close", None))
        self.label_2.setText(QCoreApplication.translate("GlobalActionsDialog", u"Global Action List", None))
        self.gaAdd_toolButton.setText(QCoreApplication.translate("GlobalActionsDialog", u"...", None))
        self.gaDel_toolButton.setText(QCoreApplication.translate("GlobalActionsDialog", u"...", None))
        self.label_3.setText(QCoreApplication.translate("GlobalActionsDialog", u"Pocket Action List", None))
        self.paAdd_toolButton.setText(QCoreApplication.translate("GlobalActionsDialog", u"...", None))
        self.paDel_toolButton.setText(QCoreApplication.translate("GlobalActionsDialog", u"...", None))
    # retranslateUi
