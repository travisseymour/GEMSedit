...
class Ui_GEMSRunDialog(object):
    def setupUi(self, GEMSRunDialog):
        if not GEMSRunDialog.objectName():
            GEMSRunDialog.setObjectName(u"GEMSRunDialog")
        ...
        self.debug_checkBox.setObjectName(u"debug_checkBox")
        ...
        self.media_checkBox.setObjectName(u"media_checkBox")
        ...
        self.fn_label.setObjectName(u"fn_label")
        font3 = QFont()
        ...
        icon = QIcon()
        icon.addFile(u":/newPrefix/media/1409889607_Play.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.dbfile_plainTextEdit.setObjectName(u"dbfile_plainTextEdit")
        self.dbfile_plainTextEdit.setEnabled(True)
        self.dbfile_plainTextEdit.setMinimumSize(QSize(0, 100))
        self.dbfile_plainTextEdit.setFont(font2)
        self.dbfile_plainTextEdit.setReadOnly(True)
        self.dbfile_plainTextEdit.setPlainText(u"")
        ...
        self.fileselect_toolButton.setObjectName(u"fileselect_toolButton")
        self.fileselect_toolButton.setFont(font2)
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/media/folder-open-icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.user_plainTextEdit.setObjectName(u"user_plainTextEdit")
        self.user_plainTextEdit.setFont(font6)
        ...
        self.user_plainTextEdit.setPlainText(u"")
        ...
        self.filename_label.setFont(font7)
    ...
    def retranslateUi(self, GEMSRunDialog):
        GEMSRunDialog.setWindowTitle(QCoreApplication.translate("GEMSRunDialog", u"Open Environment in GEMS Runner", None))
        self.label_7.setText(QCoreApplication.translate("GEMSRunDialog", u"If Data File Exists: ", None))
#if QT_CONFIG(tooltip)
        self.overwrite_radioButton.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"Overwrite any existing data file with same filename.", None))
#endif // QT_CONFIG(tooltip)
        self.overwrite_radioButton.setText(QCoreApplication.translate("GEMSRunDialog", u"Overwrite", None))
#if QT_CONFIG(tooltip)
        self.rename_radioButton.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"Rename data file if existing ones exist.", None))
#endif // QT_CONFIG(tooltip)
        self.rename_radioButton.setText(QCoreApplication.translate("GEMSRunDialog", u"Rename", None))
#if QT_CONFIG(tooltip)
        self.debug_checkBox.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"Primarily for printing behavioral data and gems_run errors to the terminal.", None))
#endif // QT_CONFIG(tooltip)
        self.debug_checkBox.setText(QCoreApplication.translate("GEMSRunDialog", u"Enable Debug Mode:  ", None))
#if QT_CONFIG(tooltip)
        self.media_checkBox.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"If disabled, audio and video resources specified in the environment file.\n"
"Useful if you don't have AVBIN installed.\n"
"Note: Speak() actions will still play.", None))
#endif // QT_CONFIG(tooltip)
        self.media_checkBox.setText(QCoreApplication.translate("GEMSRunDialog", u"Enable Media Playback:  ", None))
        self.fn_label.setText(QCoreApplication.translate("GEMSRunDialog", u"GEMS Runner Settings", None))
        self.run_pushButton.setText(QCoreApplication.translate("GEMSRunDialog", u"Launch GEMS Runner", None))
#if QT_CONFIG(tooltip)
        self.save_checkBox.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"If enabled, gems_run will save behavioral data to a data file.", None))
#endif // QT_CONFIG(tooltip)
        self.save_checkBox.setText(QCoreApplication.translate("GEMSRunDialog", u"Save Data:  ", None))
        self.labelAppName.setText(QCoreApplication.translate("GEMSRunDialog", u"GEMS Editor", None))
        self.label_6.setText("")
        self.close_pushButton.setText(QCoreApplication.translate("GEMSRunDialog", u"CLOSE", None))
        self.label.setText(QCoreApplication.translate("GEMSRunDialog", u"Environment\n"
" Database File:", None))
        self.label_4.setText(QCoreApplication.translate("GEMSRunDialog", u"User ID:", None))
#if QT_CONFIG(tooltip)
        self.dbfile_plainTextEdit.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"Click Folder Icon To Choose A Gems Environment Database File.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.fileselect_toolButton.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"Click To Choose A Gems Environment Database File.", None))
#endif // QT_CONFIG(tooltip)
        self.fileselect_toolButton.setText(QCoreApplication.translate("GEMSRunDialog", u"...", None))
#if QT_CONFIG(tooltip)
        self.user_plainTextEdit.setToolTip(QCoreApplication.translate("GEMSRunDialog", u"Specify a user id. Used to name data file.", None))
#endif // QT_CONFIG(tooltip)
        self.filename_label.setText(QCoreApplication.translate("GEMSRunDialog", u"Data Filename: gemsrun.txt", None))
    # retranslateUi
