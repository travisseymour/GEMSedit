...
condition_desc = {
    ...
    "KeyBufferContains": "<b>KeyBufferContains</b>(String,IgnoreCase) : This condition returns <i>true</i> when the keyboard buffer contains the characters in <b><i>Keys</i></b>. Use only these characters: [a-zA-Z0-9 -_./]. Optionally set <b>IgnoreCase</b> to True(default is False). It is recommended that the action ClearKeyBuffer() precede use of this condition.",
}
...
action_desc = {
    ...
    "PlayVideo": "<b>PlayVideo</b>(VideoFile,Start,Left,Top,WithinObject) : This action instructs GEMS to play the video in <b><i>VideoFile</i></b> at position (<b><i>Left</i></b>,<b><i>Right</i></b>). The soundfile beings playing at <b><i>Start</i></b> seconds [Default = 0 = beginning]. If <b><i>WithinObject</i></b> refers to a currently visible object, the video will play within that object's boundary. Otherwise, the video will play fullscreen.",
    ...
    "RunProgram": "<b>RunProgram</b>(Application,Parameters) : This action caused GEMS execute <b><i>Application</i></b> with the optional <b><i>Parameters</i></b>.",
    "SayText": "<b>SayText</b>(Message) : This action causes GEMS to speak the given <b><i>Message</i></b> using the default voice.",
    "TextBox": "<b>TextBox</b>(Message,Left,Top,Duration,FontColor) : This action causes GEMS to draw a textbox over the view containing the text in <b><i>Message</i></b>. The message will be positioned at <b><i>Left</i></b> pixels from the left and <b><i>Top</i></b> pixels from the top of the view. After <b><i>Duration</i></b> seconds [default = 0 = forever], the textbox will be removed. Set <b><i>FontColor</i></b> as desired. if left,top is (-1, -1), message origin will be current mouse position.",
    ...
    "HideObject": "<b>HideObject</b>(Object) : This action causes GEMS to make invisible the object identified as <b><i>Object</i></b>.",
    "ShowObject": "<b>ShowObject</b>(Object) : This action causes GEMS to make visible the object identified as <b><i>Object</i></b>.",
    "AllowTake": "<b>AllowTake</b>(Object) : This action causes GEMS to make <i>Takeable</i> the object identified as <b><i>Object</i></b>.",
    "DisallowTake": "<b>DisallowTake</b>(Object) : This action causes GEMS to remove the <i>Takeable</i> property of the object identified as <b><i>Object</i></b>.",
    "ChangeCursor": "<b>ChangeCursor</b>(Cursor) : This action causes GEMS to change the mouse cursor to <b><i>Cursor</i></b>.",
    "SetVariable": "<b>SetVariable</b>(Variable,Value) : This action set the user created token <b><i>Variable</i></b> to <b><i>Value</i></b>. If <b><i>Variable</i></b> does not exist, it will be created first.",
...
# NOTE: These are being indexed by the setting_item value which differ from scheme used for other keys in this module!
#       feb 10 2022 -tls
settings_desc = {
    "Id": "",
...
display_desc = {
    "Windowed": "<b>Windowed</b> : Each view"
    "s image is viewed in an application window of the same size.",
    "Fullscreen": "<b>Stretch</b> : GEMS is run in fullscreen mode, with each view"
    "s image stretched to fill the screen.",
}
