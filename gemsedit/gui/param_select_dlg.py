...
class Ui_parameterSelectDialog(object):
    def setupUi(self, parameterSelectDialog):
        if not parameterSelectDialog.objectName():
            parameterSelectDialog.setObjectName(u"parameterSelectDialog")
        ...
        self.xx_tableView.setObjectName(u"xx_tableView")
        font1 = QFont()
        ...
        self.xxparamLabel.setObjectName(u"xxparamLabel")
        font2 = QFont()
        font2.setFamilies([u"Verdana"])
        font2.setPointSize(16)
        font2.setItalic(False)
        self.xxparamLabel.setFont(font2)
        self.xxparamLabel.setStyleSheet(u"background-color: rgb(255, 204, 102);")
        ...
        self.xxparam_tableView.setObjectName(u"xxparam_tableView")
        ...
        self.resultLabel.setStyleSheet(u"background: rgb(255, 255, 255)")
        ...
        self.titleLabel.setStyleSheet(u"background-color: rgb(102, 204, 255)")
        ...
        self.xxLabel.setObjectName(u"xxLabel")
        self.xxLabel.setFont(font2)
        self.xxLabel.setStyleSheet(u"background-color: rgb(255, 204, 102);")
    ...
    def retranslateUi(self, parameterSelectDialog):
        parameterSelectDialog.setWindowTitle(QCoreApplication.translate("parameterSelectDialog", u"Dialog", None))
        self.xxparamLabel.setText(QCoreApplication.translate("parameterSelectDialog", u"XX Parameter List", None))
        self.labelAppName.setText(QCoreApplication.translate("parameterSelectDialog", u"GEMS Editor", None))
        self.label_6.setText("")
        self.cancelButton.setText(QCoreApplication.translate("parameterSelectDialog", u"Cancel", None))
        self.applyButton.setText(QCoreApplication.translate("parameterSelectDialog", u"Apply", None))
        self.resultLabel.setText(QCoreApplication.translate("parameterSelectDialog", u"...", None))
        self.titleLabel.setText(QCoreApplication.translate("parameterSelectDialog", u"XX Editor", None))
        self.xxHelpLabel.setText(QCoreApplication.translate("parameterSelectDialog", u"...", None))
        self.Label9.setText(QCoreApplication.translate("parameterSelectDialog", u"Description:", None))
        self.xxLabel.setText(QCoreApplication.translate("parameterSelectDialog", u"XX List", None))
        self.Label9_2.setText(QCoreApplication.translate("parameterSelectDialog", u"Result:", None))
    # retranslateUi
