...
class Ui_parameterSelectDialog(object):
    ...
    def retranslateUi(self, parameterSelectDialog):
        parameterSelectDialog.setWindowTitle(QCoreApplication.translate("parameterSelectDialog", "Dialog", None))
        self.xxparamLabel.setText(QCoreApplication.translate("parameterSelectDialog", "XX Parameter List", None))
        self.labelAppName.setText(QCoreApplication.translate("parameterSelectDialog", "GEMS Editor", None))
        self.label_6.setText("")
        self.cancelButton.setText(QCoreApplication.translate("parameterSelectDialog", "Cancel", None))
        self.applyButton.setText(QCoreApplication.translate("parameterSelectDialog", "Apply", None))
        self.resultLabel.setText(QCoreApplication.translate("parameterSelectDialog", "...", None))
        self.titleLabel.setText(QCoreApplication.translate("parameterSelectDialog", "XX Editor", None))
        self.xxHelpLabel.setText(QCoreApplication.translate("parameterSelectDialog", "...", None))
        self.Label9.setText(QCoreApplication.translate("parameterSelectDialog", "Description:", None))
        self.xxLabel.setText(QCoreApplication.translate("parameterSelectDialog", "XX List", None))
        self.Label9_2.setText(QCoreApplication.translate("parameterSelectDialog", "Result:", None))
